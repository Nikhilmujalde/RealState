        ...
        <div className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} action="" className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1'>
                    ...
                    <button disabled={loading || uploading} className='p-3 mt-4 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80'>{loading? 'Creating...': 'Create Listing'}</button>
